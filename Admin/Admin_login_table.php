...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `admin_login` WHERE CONCAT(`id`,`uname`) LIKE '%".$valueToSearch."%'";
...
<body>
  ...
  <form method="POST" enctype="multipart/form-data"  style="width: 90%; margin-left: 65px; margin-top: 20px">
    <div class="card-header">
      <i class="fas fa-edit"></i> Admin Account Table 
      ...
      <a href="/VetSched/Admin/Add_admin_form.php/" type="submit" class="btn"  name="Add" style="float:right; margin-left: 0.3%; padding: 5px 10px; margin-top:-0.3%; margin-right: 20px; background-color: #1f5c55; color: white "><i class="fas fa-user-plus"></i> Add Account</a>
    </div>
    <div class="card">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="Edit_admin_table.php?id=<?php echo $row['id'] ?>" class="btn btn-info" style=" padding: 2%; margin-right: 20px"><i class="fa fa-xs fa-user-edit"></i></a>
              <a href="Delete_admin.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger"  style=" padding: 2%;" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i></a>
