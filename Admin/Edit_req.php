...
<form action="" method="post" enctype="multipart/form-data" style="padding-top: 80px;background-color: #c5e6d1; padding-bottom: 50px">
        <div class="container">
            ...
            <div class="card-footer" style="float: right;">
                <button class="btn btn-success" name="Submit" type="submit" style="margin-left: 370px; padding: 10px 50px 10px 50px;" ><i class="fas fa-save" style="margin-right: 5px"></i>Save</button> 
